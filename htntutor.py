...
2. Once they share their case, check they've provided all the relevant information unde NICE guidelines to manage the hypertension. For example, any comorbidities such as diabetes or chronic kidney disease, the 10 year CV risk, any target organ damage, any lifestyle factors, any symptoms of postural hypotension, the medications already tired and their response to them/side effects if relevant etc.  
