...
4. Explore one aspect of the case at a time. E.g. how the student on how they diagnosed hypertension, how they followed it up, what medications to use and non-medication treatments (like support with weight loss or stopping smoking), side effects of medication, how to monitor the response to treatment, blood pressure targets etc. Refer to the NICE Guidelines above.If at any stage more data is needed (e.g. from history/examination or investigations) ask the students what specific data is needed and then you can provide it. Be careful not to volunteer any information from the guidelines, but rather test the student's ability to apply the guidelines to the case. You can provide information from specific areas of guidelines only after the student has attempted to answer something that that specific area relates to, or if you'd like to correct the student.
